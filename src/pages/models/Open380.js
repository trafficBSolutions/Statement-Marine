...
const Open380 = () => (
    <ModelPage
        name="380 Open"
        subtitle="The Ultimate in Center Console Performance"
        heroImg="models-gallery-380.jpg"
        description="The flagship of our center console line, the 380 Open represents the perfect combination of style and performance. Luxurious seating throughout can accommodate a dozen of your closest friends, while an advanced, twin-step hull design creates a soft, dry ride when the chop kicks up. Like all Statements, the 380 Open offers a tremendous range of design options, from custom hull and outboard paint, to high-end upholstery, to your choice of triple or quad Mercury power packages."
        highlights={[
            {
                title: 'Triple and Quad Power Options',
                text: 'The 380 Open delivers exciting performance with a wide range of available triple and quad Mercury Marine and Mercury Racing power packages, each carefully optimized for speed and efficiency by our seasoned rigging staff.',
            },
        ]}
        specs={{
            'LOA': "37'7\"",
        ...
        features={{
            ...
            'Mechanical': [
                ...
                'Mercury Racing K-Plane trim tabs with actuators',
            ],
        }}
        options={{
            'Paint & Finishes': [
            ...
            'Seating & Convenience': [
                'Helm cooler seat w/ livewell',
                'Helm bolster seats',
                'Helm seat w/ rear-facing lounge',
                'Console folding footrest',
                'Sunshade',
                'Freshwater shower, transom',
                'Bow seating w/ table and filler cushion',
                'Bow seating w/ table and sunpad',
            ...
            'Electronics & Audio': [
                'Garmin 8616 single or dual',
                'Radar',
                'Autopilot interface',
                'Stereo — AM/FM/Bluetooth w/ remote, (12) 6.5" speakers, (2) 10" subs, (3) amps',
                'Full custom audio system',
                'Mercury VesselView',
                'FLIR fixed-mount or remote-control night vision',
            ],
            'Fishing': [
                'Fishing transom — aft livewell, folding seat w/ removable backrest, 6 rod holders',
                '(5) hardtop rod holders',
                'Under-gunnel racks for (8) rods',
                'Taco Grand Slam 18\' outriggers',
                'Flush-mount stainless rod holders',
                'Flush-mount stainless combination rod/cup holders',
            ],
        }}
    />
);

export default Open380;
